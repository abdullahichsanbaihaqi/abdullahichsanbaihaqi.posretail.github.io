        ...
        <div class="col-12">
          ...
          <div class="card">
              ...
              <div class="card-header clearfix">
                <a href="/product/add_product" class="btn btn-info float-left"><i class="fas fa-plus"></i></a>           
              </div>
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr id="tr{{$val->id}}" style="text-align: center">
                  ...
                  <td>{{$val->get_category->CategoryName}}</td>
                  <td>{{number_format($val->Price)}}</td> 
                  <td>{{$val->id}}</td>
                  <td style="width: 100px">
                    <a href="/product/edit_product/{{$val->id}}" class="btn btn-warning" ><i class="fas fa-edit"></i></a>
